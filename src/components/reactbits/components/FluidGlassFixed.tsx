...
import { useRef, useState, useEffect, memo, ReactNode, useMemo, Suspense } from "react";
import {
  Canvas,
  createPortal,
  useFrame,
...
// Scene content separated from Canvas to avoid re-creating Canvas
function FluidGlassScene({
  mode = "lens",
  lensProps = {},
  barProps = {},
  cubeProps = {},
...
function FluidGlassComponent(props: FluidGlassProps) {
...
const FluidGlass = memo(FluidGlassComponent);
